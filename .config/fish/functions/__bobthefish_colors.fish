function __bobthefish_colors -S -a color_scheme -d 'Define colors used by bobthefish'
  switch "$color_scheme"
    ...
    case 'dracula' # https://draculatheme.com
      ...
      set -l fg           f8f8f2 d5c4a1 000000
      set -l comment      6272a4
      set -l cyan         8be9fd
      set -l green        50fa7b 
      set -l orange       ffb86c fb4934
      set -l pink         ff79c6
      set -l purple       bd93f9
      set -l red          ff5555 660000
      set -l yellow       f1fa8c
      set -l blue     83a598 458588
      set -l grey     cccccc 999999 333333

      set -x color_initial_segment_exit  $red[1] $black  --bold
      set -x color_initial_segment_su    $red[1] $purple --bold
      set -x color_initial_segment_jobs  $red[1] $comment --bold
      ...
      set -x color_repo_dirty            $red[1] $bg
      set -x color_repo_staged           $yellow $bg

      set -x color_vi_mode_default       $bg $yellow --bold
      set -x color_vi_mode_insert        $green $bg --bold
      set -x color_vi_mode_visual        $orange[1] $bg --bold

      set -x color_vagrant               $pink $bg --bold
      set -x color_k8s                   $green $fg[2] --bold
      set -x color_username              $blue[2] $black --bold
      set -x color_hostname              $blue[2] $bg
      set -x color_rvm                   $red[1] $bg --bold
